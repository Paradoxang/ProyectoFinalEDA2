...
const SignUp = () => {
  ...
  return (
    <form className='flex-auto p-8'>
            <label htmlFor="registrarse" className="block mb-4 text-4xl font-black text-white font-titleSans dark:text-white">Registrarse</label>
            ...
            {!email ? (
                <>
                    <div className="flex-auto p-2 grid gap-6 mb-6 md:grid-cols-2">
                        <div>
                            <label htmlFor="first_name" className="block mb-2 text-sm font-medium text-white font-titleMono dark:text-white">Nombres</label>
                            <input type="text" value={userName} onChange={onSetUserName} id="first_name" className="bg-red-50 border border-red-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" placeholder="Pablo Motos" required />
                        </div>
                        <div className="mb-6">
                            <label htmlFor="email" className="block mb-2 text-sm font-medium text-white font-titleMono dark:text-white">Correo Electrónico</label>
                        ...
                        <div className="mb-6">
                            <label htmlFor="password" className="block mb-2 text-sm font-medium text-white  font-titleMono dark:text-white">Contraseña</label>
                        ...
                        <div className="mb-6">
                            <label htmlFor="confirm_password" className="block mb-2 text-sm font-medium text-white font-titleMono dark:text-white">Confirme Contraseña</label>
                            <input type="password" id="confirm_password" value={password2} onChange={onSetPassword2} className="bg-red-50 border border-red-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="•••••••••" required />
                        </div>
                    </div>
                    <button type="submit" onClick={onClickRegister} className="text-white bg-navColor font-system hover:bg-red-900 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-4 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Ingresar</button>
                </>
            ) : (
                <>
