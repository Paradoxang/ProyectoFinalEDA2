...
export function MovieCard({ movieId, title, description, imgSrc, imgAlt,puntuation, reviews, categoria, critica}) {
    const [showDescription, setShowDescription] = useState(false);
    
    return (
        <Link to={`/movie/${movieId}`} style={{ textDecoration: "none" }} state={{ movieId, title, description, imgSrc, puntuation, reviews, categoria, critica }}>
            <div
